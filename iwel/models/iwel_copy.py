                ...
                for recordart in recordfam.ligne_article:
                    ...
                    if recordart.coeff == 0:
                        if recordfam.coeff == 0:
                            if record.coeff != 0:
                                recordart.list_price = recordart.prixbase * (1 + record.frais / 100) * (
                                        1 + record.coeff / 100)
                        else:
                            recordart.list_price = recordart.prixbase * (1 + recordfam.frais / 100) * (
                                    1 + recordfam.coeff / 100)
                    else:
                        recordart.list_price = recordart.prixbase * (1 + recordart.frais / 100) * (
                                1 + recordart.coeff / 100)
