...
class pos_gift_coupon(models.Model):
    ...
    def search_coupon(self, code):
        ...
        if coupon_code_record:
            print('==================================================')
            print("=======>coupon_code_record.coupon_count", coupon_code_record.coupon_count)
            print("=======>coupon_code_record.coupon_apply_times", coupon_code_record.coupon_apply_times)
            print('==================================================')
            ...
            if config_record.max_exp_date:
                if self.expiry_date:
                    if self.expiry_date > config_record.max_exp_date:
                        raise Warning(_(
                            "Please Enter Valid Date.Expiry Date is greater than maximum expiry date of coupon configuration"))

                if self.issue_date > config_record.max_exp_date:
                    raise Warning(_(
                        "Please Enter Valid Date.Issue Date is greater than maximum expiry date of coupon configuration."))
